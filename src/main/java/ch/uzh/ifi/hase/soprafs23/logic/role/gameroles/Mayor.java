...
public class Mayor extends Role implements TiedPollDecider, DayVoter, NightVoter, PlayerObserver{
    ...
    public Mayor(Supplier<List<Player>> alivePlayersGetter, BiConsumer<Player, Class<? extends Role>> addPlayerToRole, TiedPollDecider noMayorDecider, Scheduler scheduler) {
